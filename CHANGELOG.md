...
### Added
- `Schema#required_keys` — return the array of keys declared as required (including required nested schemas).
- `Schema#optional_keys` — return the array of keys declared as optional.
